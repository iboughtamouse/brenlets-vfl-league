...
Scores update nightly via an automated job. Since VFL game weeks don't change by the minute, nightly is sufficient. An on-demand "refresh now" trigger would be a nice-to-have for after game weeks officially close.
